...
$numProd = 0;
$query  = "SELECT a.id,a.code,a.name,a.".$quePrec.",a.unit,c.name AS div,b.name AS dpto, a.photo_url, a.current_stock,a.stock_tot, a.checked";
...
foreach ($consult as $value){
  ...
  //  $objRtn->cost_max = ($tipoPrec == 0)? round($value->cost_max,3) : roud($value->cost_mayor,3);
