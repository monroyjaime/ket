...
foreach ($consult as $value){
    ...
    if($value->unique_photo == 'f')
        $tags1 .= '<a class="dropdown-item" href="#" onClick="javascript:getCatalogoNormal('.$dpto_Id.')">'.$dpto_name.'</a>';
    else
        $tags1 .= '<a class="dropdown-item" href="#" onClick="javascript:getCatalogoUnique('.$dpto_Id.')">'.$dpto_name.'</a>';
    /*
...
<html>
    ...
    <script type="text/javascript">
        function getCatalogoNormal(idDpto){   //,checkNum){
            ...
            urlString =  "indexDptoAll2.php?dpto_id="+idDpto;
