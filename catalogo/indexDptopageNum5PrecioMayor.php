...
$query  = "SELECT id,code,name,photo_url,cost_mayor,unit,current_stock FROM productos WHERE show='t' AND dpto_id=";
...
foreach ($consult1 as $value){
    ...
    $productVal->cost = floatval($value->cost_mayor);
