...
$numPages = ceil($numProducts/12);

$lastPageProdNum = ($pageNum == $numPages)? 12 - (($numPages*25 - $numProducts) + 1) : 11;
$tags = '<div class="col text-center">';

$tags .=    '<h2>Catalogo de '.$currCatName.' (Pag. '.$pageNum.' / '.$numPages.')';
$tags .= '</div>';

$tags .=    '<div class="row row-cols-1 row-cols-sm-3 g-3 ">';



$currProd=0;
$currRangeFrom = ($pageNum-1)*12;
$currRangeTo = ($pageNum-1)*12 + $lastPageProdNum;
...
//    $tags .=            '<div class="card-body" style="background-color: #034c4a;">';
    $tags .=            '<div class="card-body" style="background-color: #FFF;">';
//    $tags .=                '<h4 style="color: #FFF;">'.$productVal_desc.'</h4>';
    $tags .=                '<h4 style="color: #000;">'.$productVal_desc.'</h4>';
    if($role>-1)
    {
