...
$numPages = ceil($numProducts/20);

$lastPageProdNum = ($pageNum == $numPages)? 20 - (($numPages*20 - $numProducts) + 1) : 19;
...
$currProd=0;
$currRangeFrom = ($pageNum-1)*20;
$currRangeTo = ($pageNum-1)*20 + $lastPageProdNum;
