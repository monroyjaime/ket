...
$dataUrl = "https://ketelectropartes.com/php/getListaAllPhoto.php";
...
<div class="col text-center" >
  ...
  <h2 style="background-color: #037C79; color: #FFF;">Listado general (fotos de Catalogo)</h2>
    ...
    <table
      ...
      <thead>
        <tr>
          ...
          <th data-field="foto" data-halign="center" data-align="center" >TIENE FOTO</th>
          <th data-field="stock" data-halign="center" data-align="right" >STOCK</th>
    ...
    $(function() {
      ...
      $('#myModal').on("hide.bs.modal", function () {
        ...
        function getLista(idDpto,rol){
            ...
            urlString ="index1.php?dpto="+idDpto+"&role_num="+rol;
