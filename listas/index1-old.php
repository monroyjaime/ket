...
$callBackLine = '<a href="#" onClick="backTo('.$role.','.$linea.')" title="Pag. Prev."><i class="bi bi-arrow-left-circle-fill icon-dark-blue icon-large"></i></a>';
    ...
    <table 
      ...
      <thead>
        <tr>
          ...
          <th data-field="photo_url" data-force-hide="true" data-formatter="fotoFormatter">FOTO</th>         
        </tr>
      </thead>
      <tfoot>
            <tr>
                ...
                <td>Lista de <?php echo $dptoName; ?></td>
...
<div class="modal fade" id="myModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    function backTo(rol,line){ 
        switch(line)
        {
          case 1:
            urlString =  "indexL1.php?role_num="+rol;

          break;
          case 2:
            urlString =  "indexL2.php?role_num="+rol;
