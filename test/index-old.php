...
foreach ($consult as $value){
    ...
    {
      $tags1 .= '<li>';
      $tags1 .= '<a class="dropdown-item" href="#" onClick="javascript:getCatalogoNormal('.$dpto_Id.','.$role.')">'.$dpto_name.'</a>';
      $tags1 .= '</li>';
    }
    else
    {
      $tags1 .= '<li>';
      $tags1 .= '<a class="dropdown-item" href="#" onClick="javascript:getCatalogoUnique('.$dpto_Id.','.$role.')">'.$dpto_name.'</a>';
      $tags1 .= '</li>';
    }
}
//echo "tags1: ".$tags1."\n";
...
foreach ($consult as $value){
    ...
    {
      $tags2 .= '<li>';
      $tags2 .= '<a class="dropdown-item" href="#" onClick="javascript:getCatalogoNormal('.$dpto_Id.','.$role.')">'.$dpto_name.'</a>';
      $tags2 .= '</li>';
    }
    else
    {
      $tags2 .= '<li>';
      $tags2 .= '<a class="dropdown-item" href="#" onClick="javascript:getCatalogoUnique('.$dpto_Id.','.$role.')">'.$dpto_name.'</a>';
      $tags2 .= '</li>';
    }
}
//echo "tags2: ".$tags2."\n";
$consult = $db->consultas("SELECT id,name,img_route,unique_photo FROM departamentos WHERE num=3 AND img_route != 'no' ORDER BY id");
foreach ($consult as $value){
    $dpto_Id = $value->id;
    $dpto_name = $value->name;
    $dpto_uniq_photo = $value->unique_photo;
    ...
    {
      $tags3 .= '<li>';
      $tags3 .= '<a class="dropdown-item" href="#" onClick="javascript:getCatalogoNormal('.$dpto_Id.','.$role.')">'.$dpto_name.'</a>';
      $tags3 .= '</li>';
    }
    else
    {
      $tags3 .= '<li>';
      $tags3 .= '<a class="dropdown-item" href="#" onClick="javascript:getCatalogoUnique('.$dpto_Id.','.$role.')">'.$dpto_name.'</a>';
      $tags3 .= '</li>';
    }
}
?>
...
<div class="col text-center">
  <div class="row row-cols-1 row-cols-sm-2 g-2 ">
    <div class="d-flex justify-content-center" style="padding-top:25px; padding-bottom:25px;" >
      <img class="d-block w-50" src="img/linea1.jpg" alt="linea1" style="max-height:50vh;max-width:50vh;">
    </div>
    <div class="d-flex justify-content-center" style="padding-top:25px; padding-bottom:25px;" >
      <img class="d-block w-50" src="img/linea2.jpg" alt="linea2" style="max-height:50vh;max-width:50vh;">
    </div>
  </div>        
</div>
