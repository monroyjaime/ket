...
$dataUrl = "https://ketelectropartes.com/php/getListaPrecAllL1.php?prec=".$tipoPrecio;
    ...
    */
    $('#myModal').on("hide.bs.modal", function () {
      ...
      $(".modal-body").html("");
        ...
        function getLista(idDpto,rol,prec){
            console.log( "selected Depertamento: "+idDpto );
            urlString ="index1.php?dpto="+idDpto+"&line=1&prec="+prec;
...
*/
        ...
        function getCatalogo(idDpto,role,prec){   //,checkNum){   
            urlString =  "../catalogo/indexDptoAll2.php?dpto_id="+idDpto+"&line=1&prec="+prec;
            window.location.href = urlString;
        }
