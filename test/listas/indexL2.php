...
$dataUrl = "https://ketelectropartes.com/php/getListaPrecAllL2.php?prec=".$tipoPrecio;
    ...
    $(function() {
        ...
        */
        ...
        function getLista(idDpto,rol,prec){
            ...
            urlString ="index1.php?dpto="+idDpto+"&line=2&prec="+prec;
...
*/
        ...
        function getCatalogo(idDpto,role,prec){   //,checkNum){   
            urlString =  "../catalogo/indexDptoAll2.php?dpto_id="+idDpto+"&line=2&prec="+prec;
            window.location.href = urlString;
        }
