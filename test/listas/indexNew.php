...
$tituloLista = ($role == -1)? '<h2 style="background-color: #037C79; color: #FFF;">Listado general</h2>' : '<h2 style="background-color: #037C79; color: #FFF;">Lista de precios general</h2>';
