...
foreach ($consult as $value)
  ...
  $listaCond  = '<li class="nav-item">';
  $listaCond .= '<a href="#" onClick="javascript:getListasPrec(-1)" style="text-decoration: none; color: #003272;"><i class="bi bi-search icon-dark-blue icon-large"></i>Buscador</a>';
  //$listaCond .= '<a class="nav-link" href="#" onClick="javascript:getListasPrec(-1)">Buscador</a>';
  $listaCond .= '</li>';

  $listaCondL1 ='<a  href="listas/indexL1.php?role_num=-1"><img class="d-block w-100" src="img/linea1.jpg" alt="linea1" style="max-height:50vh;max-width:50vh;"></a>';
  $listaCondL2 ='<a  href="listas/indexL2.php?role_num=-1"><img class="d-block w-100" src="img/linea2.jpg" alt="linea1" style="max-height:50vh;max-width:50vh;"></a>';
  ...
  if ( isset($_POST['usr_num']) && isset($_POST['ses_num']) && isset($_POST['ses_id']) ) 
  {
    ...
    $listaCond  = '<li class="nav-item">';
    $listaCond .= '<a href="#" onClick="javascript:getListasPrec('.$role.')" style="color: #003272"><i class="bi bi-search icon-dark-blue icon-large"></i>Buscador</a>';
    //$listaCond .= '<a class="nav-link" href="#" onClick="javascript:getListasPrec('.$role.')">Buscador con Precio</a>';
    $listaCond .= '</li>';

    $listaCondL1 ='<a  href="listas/indexL1.php?role_num='.$role.'"><img class="d-block w-100" src="img/linea1.jpg" alt="linea1" style="max-height:50vh;max-width:50vh;"></a>';
    $listaCondL2 ='<a  href="listas/indexL2.php?role_num='.$role.'"><img class="d-block w-100" src="img/linea2.jpg" alt="linea1" style="max-height:50vh;max-width:50vh;"></a>';
...
<!--        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><b>Login</b> <span class="caret"></span></a> -->
          <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="bi bi-person-circle icon-dark-blue icon-large"></i></a>
...
<div class="col text-center">
  <div class="row row-cols-1 row-cols-sm-2 g-2 ">
    <div id="imgLinks" class="d-flex justify-content-center" >
      <?php echo $listaCondL1; ?>
      <!-- <a  href="#"><img class="d-block w-50" src="img/linea1.jpg" alt="linea1" style="max-height:50vh;max-width:50vh;"></a> -->
    </div>
    <div id="imgLinks" class="d-flex justify-content-center" >
      <?php echo $listaCondL2; ?>
      <!-- <a  href="#"><img class="d-block w-50" src="img/linea2.jpg" alt="linea2" style="max-height:50vh;max-width:50vh;"></a> -->
    </div>
  </div>        
</div>
