...
foreach ($consult as $value)
  ...
  $listaCondL0 ='<a  href="listas/index.php?role_num=-1"><img class="d-block w-100" src="img/linea0.jpg" alt="linea0" style="max-height:50vh;max-width:50vh;"></a>';
  ...
  $listaCondL2 ='<a  href="listas/indexL2.php?role_num=-1"><img class="d-block w-100" src="img/linea2.jpg" alt="linea2" style="max-height:50vh;max-width:50vh;"></a>';
  ...
  if ( isset($_POST['usr_num']) && isset($_POST['ses_num']) && isset($_POST['ses_id']) ) 
  {
    ...
    $listaCondL0 ='<a  href="listas/index.php?role_num='.$role.'"><img class="d-block w-100" src="img/linea0.jpg" alt="linea0" style="max-height:50vh;max-width:50vh;"></a>';
    ...
    $listaCondL2 ='<a  href="listas/indexL2.php?role_num='.$role.'"><img class="d-block w-100" src="img/linea2.jpg" alt="linea2" style="max-height:50vh;max-width:50vh;"></a>';
...
/*    $consult = $db->consultas("SELECT COUNT(num) FROM sesion WHERE active='t' AND ip_client = '".$ip."'");
    ...
    if($sesionAlreadyActive)
    {
      ...
      $listaCondL1 ='<a  href="listas/indexL1.php?role_num='.$role.'"><img class="d-block w-100" src="img/linea1.jpg" alt="linea1" style="max-height:50vh;max-width:50vh;"></a>';
      $listaCondL2 ='<a  href="listas/indexL2.php?role_num='.$role.'"><img class="d-block w-100" src="img/linea2.jpg" alt="linea0" style="max-height:50vh;max-width:50vh;"></a>';
