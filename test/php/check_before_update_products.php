...
$query = "SELECT code,name,cost_max,unit,current_stock,dpto_code,orden FROM prod_name order BY code";
...
{
    $found = 0;
    $query1 = "SELECT name,cost_max,unit,current_stock,dpto_code,orden FROM productos where code='".$value1->code."'";
...
//            }
        ...
        {
//            if($db->querySet("UPDATE pcurrent_stockroductos SET unit = ".$value1->unit."' WHERE code ='".$value1->code."'") == 1)
//            {
...
//            }
        ...
        {
            echo ($count5."::updated dpto_code:: CODE: ".$value1->code." before: ".$value2->dpto_code." after : ".$value1->dpto_code."\n");
            $count5++;
        }

        if($value1->orden != $value2->orden)
        {
            echo ($count6."::updated orden:: CODE: ".$value1->code." before: ".$value2->orden." after : ".$value1->orden."\n");
            $count6++;
        }
