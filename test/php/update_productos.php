...
foreach ($consult1 as $value1)
{
    ...
    foreach($consult2 as $value2)
    {
        ...
        if(number_format(floatval($value1->cost_oferta),2) != number_format(floatval($value2->cost_oferta),2))
        {
        ...
        if(number_format(floatval($value1->cost_mayor),2) != number_format(floatval($value2->cost_mayor),2))
        {
        ...
        if(number_format(floatval($value1->cost_min),2) != number_format(floatval($value2->cost_min),2))
        {
