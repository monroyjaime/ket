...
<html>
  ...
  <div class="container-fluid">
     ...
     <a href="#" class="navbar-brand me-2 mb-1 d-flex align-items-center" href="#">
        ...
        <a href="./listas/" class="btn-link"><i class="bi bi-search icon-dark-blue icon-large"></i></a>
  ...
  <div class="row">
    <div id="contact" class="col-sm">
      ...
      <p>
        ...
        <a href="https://wa.me/584143161207" class="btn-link me-1" ><i class="bi bi-whatsapp icon-large" style="color: #25d366;"></i><---Haga su pedido aqui</a>
        <a href="https://www.instagram.com/ketccs/" class="btn-link me-1"><i class="bi bi-instagram icon-large" style="color: #ac2bac;"></i></a>
      </p>
      <p>
        <h5>e-mail:</h5>
        <h5>ventasket@gmail.com</h5>
      </p>
