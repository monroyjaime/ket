      ...
      //$icon_admin = ($admin == 0)? '' : '<a href="./admin/" class="btn-link" id="btnsMenu"><i class="bi bi-pencil-square icon-dark-blue icon-large"></i></a>';
        $icon_admin ='';
            if($admin ==1)
            {
              ...
              $icon_admin  .=        '<li>';
             // $icon_admin  .=            '<div class="row">';
              $icon_admin  .=                '<a href="./admin/pedidos" class="btn-link text-decoration-none text-dark p-2 rounded hover-bg-light d-block" id="btnsMenu">';
              $icon_admin  .=                    '<h5 class="d-inline ms-2">Pedidos</h5>';
              $icon_admin  .=                '</a>';
             // $icon_admin  .=            '</div>';
              $icon_admin  .=        '</li>';
              $icon_admin  .=        '<li>';
             // $icon_admin  .=            '<div class="row">';
              $icon_admin  .=                '<a href="./admin/presupuestos" class="btn-link text-decoration-none text-dark p-2 rounded hover-bg-light d-block" id="btnsMenu">';
              $icon_admin  .=                    '<h5 class="d-inline ms-2">Presupuestos</h5>';
              $icon_admin  .=                '</a>';
             // $icon_admin  .=            '</div>';
              $icon_admin  .=        '</li>';
